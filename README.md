...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdocs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11044&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdocs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdocs` can be installed with:

```
conda install pdocs
```

It is possible to list all of the versions of `pdocs` available on your platform with:
